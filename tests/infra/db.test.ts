...
import { users, sessions } from "../../src/infrastructure/db/schema";
...
describe("Database Infrastructure & Migrations (M1 #42)", () => {
  ...
  it("has 0001_init_auth.sql migration creating users and sessions tables", () => {
  ...
  it("defines users and sessions tables in Drizzle schema", () => {

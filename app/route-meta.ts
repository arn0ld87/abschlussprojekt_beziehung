...
export const ROUTE_META: Record<string, RouteMetaEntry> = {
  ...
  "page:/sitzplaene": { status: "yellow", hint: "Sitzplanliste, Login nötig · M3-56" },
  "page:/sitzplaene/neu": { status: "yellow", hint: "Neuer Sitzplan aus Klasse und Raumvorlage, Login nötig · M3-56" },
  "page:/sitzplaene/[id]": { status: "yellow", hint: "Sitzplan-Editor-Shell — ab /sitzplaene navigieren · M3-56" },
  ...
  "api:/api/raeume/[id]/objekte/[objektId]/aktionen": { status: "green", hint: "M2-53" },
  "api:/api/sitzplaene": { status: "green", hint: "M3-56" },
  "api:/api/sitzplaene/[id]": { status: "green", hint: "M3-56" },
  "api:/api/sitzplaene/[id]/zuordnungen": { status: "green", hint: "Schülerzuordnung schreiben · M3-57" },
